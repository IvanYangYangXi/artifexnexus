...
id: STORY-0047
kind: story
title: M4-UI-01 · Web UI：Skill/Tool 管理面板接线
status: backlog
priority: P1
owner: "@ivan"
assignee: pair
...
related_packages:
  - "packages/apps/web"
  - "apps/desktop"
tags: [story, ui, skill, tool, tauri, invoke, M4, M5]
---

# STORY-0047 · Web UI：Skill/Tool 管理面板接线

## 用户故事
技能管理页面从 mock 数据切换到真实 sidecar RPC，Skill 和 Tool 的安装/启用/禁用/钉选/收藏全部真实可用。
...
| `packages/apps/web/src/lib/tool/tool-api.ts` | 新写 (~150行) | 全写 |
