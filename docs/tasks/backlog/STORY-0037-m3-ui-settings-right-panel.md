...
## 用户故事
在设置模块中配置模型/认证/Agent/通用设置；右侧面板显示最近使用/Skill/Tool/资源管理器/文件预览。

## 验收标准

### 设置模块
- [ ] 设置分类导航：模型 / 认证 / Agent / 通用
...
### D 区域右侧面板
- [ ] D 区域可隐藏/显示，宽度可拖拽 240–640px
- [ ] D1 最近使用：最近 10 项 Skill+Tool，按时间倒序
- [ ] D2 Skill 列表：状态点+名称+版本+[📌钉选]，可折叠
- [ ] D3 Tool 列表：按 Skill 分组折叠，每行图标+函数名+[▶运行]
- [ ] D4 资源管理器：树形目录，点击文件联动 D5 预览
- [ ] D5 文件预览：.md 渲染 / .py/.json/.ts 语法高亮 / 图片缩略图
