...
|----------|------|
| `not_installed` | `[详情]` `[安装]` |
| `installed` | `[详情]` `[运行]` `[收藏/取消收藏]`（user 来源额外：`[编辑]` `[发布]` `[删除]`） |
| `update_available` | `[详情]` `[运行]` `[更新]` |

**详情界面**：点击 `[详情]` 弹出 Tool 详情对话框，包含：
- 完整描述、参数签名、所属 Skill 信息
- `[打开安装目录]` — 在资源管理器中打开 Tool 安装路径
...
| `actions` | 详情/安装/卸载/启用/禁用/更新/发布/钉选 | 详情/安装/运行/收藏/编辑/发布/删除/更新 |
| `favorited` | — | 是否已收藏 |
| `pinned` | 是否已钉选 | — |
