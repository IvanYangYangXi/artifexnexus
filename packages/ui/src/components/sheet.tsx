...
/**
 * Sheet — 侧边滑入抽屉（基于 Radix Dialog）
 * Side sheet drawer based on Radix Dialog
 *
 * 对齐 docs/specs/ui/component-inventory.md §4
 * 主要场景：< 768px 响应式 B 区抽屉、移动端 D 区面板从右侧滑入。
 *
 * 与 Dialog 的区别：从屏幕边缘滑入（非居中），通常铺满一整边。
 */
...
const sheetVariants = cva(
  [
    // 玻璃面（风格 E）：blur + 半透明 background 底 + 顶部 inset 高光
    "fixed z-50 gap-4 p-6 transition ease-in-out",
    "border-white/[0.08] bg-background/80 backdrop-blur-xl",
